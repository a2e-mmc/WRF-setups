...
OUT_DIR_BASE="/glade/scratch/$USER/WRF/MMC/FINO1/20100512_to_20100526/ERA5_MYJ_CHRN_OST_NOSK_3DOM/${CASE_STR}"
# LOCATION OF WPS EXECUTABLES
WPS_DIR="/glade/work/$USER/Models/WRF/WRFvMMC/WPS"
# LOCATION OF WHERE TO DOWNLOAD REANALYSIS DATA
ICBC_DIR="/glade/scratch/$USER/WRF/ICBC"
# LOCATION OF WRF EXECUTABLES
EXE_DIR="/glade/work/$USER/Models/WRF/WRFvMMC/WRF/run"
